...
AnimatedSprite::AnimatedSprite()
	: m_pVertexData(0), m_iFrameWidth(0), m_iFrameHeight(0), m_iCurrentFrame(0), m_iTotalFrames(0), m_fTimeElapsed(0)
	, m_bAnimating(false), m_bLooping(false), m_frameDuration(1.0f), totalTime(0.0f)
{
